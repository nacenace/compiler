...
struct Symbol {
  ...
  llvm::Type *get_elementtype(CodegenContext &context) {
    return typeNode->type == Type::ARRAY ? cast_node<ArrayTypeNode>(typeNode)->elementType->get_llvm_type(context) : nullptr;
  }
